...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("DatabaseCustomerDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class DatabaseCustomerDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As DatabaseCustomerDataSet = CType(MyBase.Clone,DatabaseCustomerDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "DatabaseCustomerDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/DatabaseCustomerDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As DatabaseCustomerDataSet = New DatabaseCustomerDataSet
    ...
    Partial Public Class customerDataTable
        ...
        Private columnMO_NO As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public ReadOnly Property MO_NOColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnMO_NO
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overloads Function AddcustomerRow(ByVal CNAME As String, ByVal GENDER As String, ByVal MO_NO As Double, ByVal CITY As String) As customerRow
            Dim rowcustomerRow As customerRow = CType(Me.NewRow,customerRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, CNAME, GENDER, MO_NO, CITY}
        ...
        Friend Sub InitVars()
            ...
            Me.columnMO_NO = MyBase.Columns("MO NO")
        ...
        Private Sub InitClass()
            ...
            Me.columnMO_NO = New Global.System.Data.DataColumn("MO NO", GetType(Double), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnMO_NO)
    ...
    Partial Public Class customerRow
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Property MO_NO() As Double
            Get
                Try 
                    Return CType(Me(Me.tablecustomer.MO_NOColumn),Double)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'MO NO' in table 'customer' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tablecustomer.MO_NOColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Function IsMO_NONull() As Boolean
            Return Me.IsNull(Me.tablecustomer.MO_NOColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetMO_NONull()
            Me(Me.tablecustomer.MO_NOColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace DatabaseCustomerDataSetTableAdapters
    ...
    Partial Public Class customerTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `customer` WHERE ((`CID` = ?) AND ((? = 1 AND `CNAME` IS NULL) OR (`C"& _ 
                ...
                " `MO NO` IS NULL) OR (`MO NO` = ?)) AND ((? = 1 AND `CITY` IS NULL) OR (`CITY` ="& _ 
                " ?)))"
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_MO_NO", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_MO_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `customer` (`CNAME`, `GENDER`, `MO NO`, `CITY`) VALUES (?, ?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("MO_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `customer` SET `CNAME` = ?, `GENDER` = ?, `MO NO` = ?, `CITY` = ? WHERE (("& _ 
                "`CID` = ?) AND ((? = 1 AND `CNAME` IS NULL) OR (`CNAME` = ?)) AND ((? = 1 AND `G"& _ 
                "ENDER` IS NULL) OR (`GENDER` = ?)) AND ((? = 1 AND `MO NO` IS NULL) OR (`MO NO` "& _ 
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("MO_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("IsNull_MO_NO", Global.System.Data.OleDb.OleDbType.[Integer], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Original, true, Nothing))
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Original_MO_NO", Global.System.Data.OleDb.OleDbType.[Double], 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "MO NO", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.customerTable.My.MySettings.Default.DatabaseCustomerConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT CID, CNAME, GENDER, [MO NO], CITY FROM customer"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DatabaseCustomerDataSet.customerDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DatabaseCustomerDataSet.customerDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As DatabaseCustomerDataSet.customerDataTable = New DatabaseCustomerDataSet.customerDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As DatabaseCustomerDataSet.customerDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As DatabaseCustomerDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_CID As Integer, ByVal Original_CNAME As String, ByVal Original_GENDER As String, ByVal Original_MO_NO As Global.System.Nullable(Of Double), ByVal Original_CITY As String) As Integer
            ...
            End If
            If (Original_MO_NO.HasValue = true) Then
                Me.Adapter.DeleteCommand.Parameters(5).Value = CType(0,Object)
                Me.Adapter.DeleteCommand.Parameters(6).Value = CType(Original_MO_NO.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal CNAME As String, ByVal GENDER As String, ByVal MO_NO As Global.System.Nullable(Of Double), ByVal CITY As String) As Integer
            ...
            End If
            If (MO_NO.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(2).Value = CType(MO_NO.Value,Double)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal CNAME As String, ByVal GENDER As String, ByVal MO_NO As Global.System.Nullable(Of Double), ByVal CITY As String, ByVal Original_CID As Integer, ByVal Original_CNAME As String, ByVal Original_GENDER As String, ByVal Original_MO_NO As Global.System.Nullable(Of Double), ByVal Original_CITY As String) As Integer
            If (CNAME Is Nothing) Then
            ...
            End If
            If (MO_NO.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(2).Value = CType(MO_NO.Value,Double)
            Else
            ...
            If (Original_MO_NO.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(10).Value = CType(Original_MO_NO.Value,Double)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As DatabaseCustomerDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateInsertedRows(ByVal dataSet As DatabaseCustomerDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._customerTableAdapter) Is Nothing) Then
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Private Function UpdateDeletedRows(ByVal dataSet As DatabaseCustomerDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._customerTableAdapter) Is Nothing) Then
        ...
        '''</summary>
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Overridable Function UpdateAll(ByVal dataSet As DatabaseCustomerDataSet) As Integer
