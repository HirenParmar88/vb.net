Public Class Form4
    ...
    Private Sub Form4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            con.Open()
            da = New OleDb.OleDbDataAdapter("SELECT * FROM Examination", con)
            da.Fill(ds)
            DataGridView1.DataSource = ds.Tables(0)
            TextBox1.Text = ds.Tables(0).Rows(c).Item(0)
            TextBox2.Text = ds.Tables(0).Rows(c).Item(1)
            ComboBox1.Text = ds.Tables(0).Rows(c).Item(2)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            cmd = New OleDb.OleDbCommand("INSERT INTO Examination VALUES(" & TextBox1.Text & "," & TextBox2.Text & ",'" & ComboBox1.Text & "')", con)
            cmd.ExecuteNonQuery()
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        Try
            cmd = New OleDb.OleDbCommand("UPDATE Examination SET CourseID=" & TextBox2.Text & ", ExamMonth= '" & ComboBox1.Text & "' WHERE ExamID=" & TextBox1.Text & "", con)
            cmd.ExecuteNonQuery()
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        Try
            cmd = New OleDb.OleDbCommand("DELETE FROM Examination WHERE ExamID= " & TextBox1.Text & "", con)
            cmd.ExecuteNonQuery()
